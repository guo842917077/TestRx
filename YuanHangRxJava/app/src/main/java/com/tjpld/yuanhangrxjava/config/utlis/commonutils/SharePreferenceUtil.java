package com.tjpld.yuanhangrxjava.config.utlis.commonutils;
...
import com.tjpld.yuanhangrxjava.config.common.APPConfig;
...
public class SharePreferenceUtil {
	...
	/** 保存在手机里面的文件名 */
	private final static String SharePreferncesName = APPConfig.Share_Login;
